...
$validator->extend('dict', \Gzhegow\Validator\Core\Rule\DictRule::class);
$validator->extend('gettype', \Gzhegow\Validator\Core\Rule\GettypeRule::class);
$validator->extend('index', \Gzhegow\Validator\Core\Rule\IndexRule::class);
$validator->extend('instance_is_a', \Gzhegow\Validator\Core\Rule\InstanceIsARule::class);
$validator->extend('instance_is_class', \Gzhegow\Validator\Core\Rule\InstanceIsClassRule::class);
$validator->extend('instance_is_subclass_of', \Gzhegow\Validator\Core\Rule\InstanceIsSubclassOfRule::class);
$validator->extend('is_a', \Gzhegow\Validator\Core\Rule\IsARule::class);
...
$validator->extend('a_host', \Gzhegow\Validator\Core\Rule\AHostRule::class);
$validator->extend('a_in', \Gzhegow\Validator\Core\Rule\AInRule::class);
$validator->extend('a_int', \Gzhegow\Validator\Core\Rule\AIntRule::class);
$validator->extend('a_link', \Gzhegow\Validator\Core\Rule\ALinkRule::class);
$validator->extend('a_of', \Gzhegow\Validator\Core\Rule\AOfRule::class);
$validator->extend('a_string', \Gzhegow\Validator\Core\Rule\AStringRule::class);
$validator->extend('a_url', \Gzhegow\Validator\Core\Rule\AUrlRule::class);
$validator->extend('a_userbool', \Gzhegow\Validator\Core\Rule\AUserboolRule::class);
$validator->extend('a_uuid', \Gzhegow\Validator\Core\Rule\AUuidRule::class);
//
