...
class IpInSubnetsV4Rule extends AbstractRule
{
    ...
    const NAME = 'ip_in_subnets_v4';

    public static function message(array $conditions = []) : string
    {
        return 'validation.ip_in_subnets_v4';
    }
    ...
    ) : ?string
    {
        ...
        if (! $theType->address_ip_v4($value[ 0 ])->isOk([ &$addressIpV4 ])) {
        ...
        $status = Lib::net()->is_ip_in_subnets_v4($addressIpV4, $subnetsV4);
